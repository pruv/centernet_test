...
def HourglassNetwork(input_images, num_stacks, cnv_dim=256, inres=(512, 512), weights='ctdet_coco',
  ...
  inter = pre(input_images, cnv_dim)
  prev_inter = None
  # outputs = []
...
def residual(_x, out_dim, name, stride=1):
  ...
  if num_channels != out_dim or stride != 1:
    shortcut = Conv2D(out_dim, 1, strides=stride, use_bias=False, name=name + '.shortcut.0')(shortcut)
